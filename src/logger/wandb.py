...
class WandBWriter:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            logger (logging.Logger): logger that logs output.
            project_config (dict): config for the current experiment.
            project_name (str): name of the project inside experiment tracker.
            entity (str | None, optional): name of the entity inside experiment
                tracker. Used if you work in a team.
            run_id (str | None, optional): the id of the current run. Defaults to None.
            run_name (str | None, optional): the name of the run. If None, random name
                is given. Defaults to None.
            mode (str, optional): if online, log data to the remote server. If
                offline, log locally. Defaults to "online".
        """
        try:
            import wandb
